...
namespace WebApplication6.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var ExisteCuenta = db.Users.Where(x=>x.Email==email);
            if (ExisteCuenta.Count()!=0)
            {
                return RedirectToAction("ExisteCuenta","Manage",new { idEmpleado });
            }
            idaux = idEmpleado;
            emailaux = email;
;
        ...
        {
            model.Email = emailaux;
            model.Password = "Colegio" + DateTime.Now.Year;
            if (model.Email!=null)
            {
               ...
               var result = await UserManager.CreateAsync(user, model.Password);
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Details", "Empleado",new { id = idaux});
                }
                AddErrors(result);
            }
            ViewBag.Rol = new SelectList(db.Roles, "Id", "Name");
