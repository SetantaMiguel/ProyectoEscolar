...
('Ver Notas'),('Agregar Empleado'),('Ver Empleados'),('Administrar Empleados'),('Agregar Grupos'),
('Ver Grupos'),('Editar Grupo'),('Eliminar Grupos'),('Ver caja'),('Realizar Transaccion'),('Editar Caja'),('Administrar Permisos'),('Administrar Años'),('Ver Años')
...
('Administrar Materias'),('Administrar Secciones'),('Administrar Secciones'),('Administrar Colegio'),('Valorar Evaluaciones');
...
INSERT INTO [dbo].[Empleadoes] ([Nombre],[Apellido],[Direccion],[Correo],[FechaNaci],[Domicilio]
	,[Telefono],[Genero],[Identificacion],[Codigo_Empleado],[EstadoCivil],[Dt_Contratacion],[BL_Estado_Empleado])
     VALUES ('Miguel','Sanchez','Direccion Administradora','miasango2@hotmail.com','2020-09-23 16:35:58.000','Managua','82143371',
	'Masculino','001-230999-0001P','School-1','Soltero','2020-09-23 16:35:58.000','true')
